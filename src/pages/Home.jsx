        ...
        <div className="container hero__new-layout">
          ...
          <div className="hero__cta-row">
            ...
            <div className="hero__inline-stats">
              <div><strong>{doctors[0]?.surgeries || '8,000+'}</strong><span>Procedures</span></div>
      ...
      <section className="stats-bar">
        <div className="container stats-bar__grid">
          {[
            ...
            { icon: <Stethoscope size={28}/>, value: (doctors[0]?.surgeries || '8000').toString().replace(/\D/g, ''), suffix: '+', label: 'Procedures' },
      ...
      <section className="appt-cta">
        <div className="container appt-cta__inner">
          ...
          <div className="appt-cta__actions">
            ...
            <a href="tel:+919183570761" className="btn btn-outline btn-lg">
              <Phone size={20}/> +91 91835 70761
            </a>
          </div>
        </div>
        {/* Decorative */}
