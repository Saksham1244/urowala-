...
export default function AdminLayout() {
  ...
  const navItems = [
    ...
    {
      to: '/admin/photo-settings',
      end: false,
      label: 'Photo Settings',
      icon: (
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          <circle cx="12" cy="12" r="3"/>
          <path d="M20.188 10.934a.5.5 0 0 0-.468-.934 9 9 0 1 0 .28 4"/>
          <path d="M15 12h6"/>
        ...
        <header className="admin-topbar">
          ...
          <div className="topbar-right">
            <div className="topbar-user-badge">
              <span className="topbar-user-avatar">{(localStorage.getItem('urowala_admin_user') || 'A')[0].toUpperCase()}</span>
              <span className="topbar-user-name">{localStorage.getItem('urowala_admin_user') || 'Admin'}</span>
            </div>
